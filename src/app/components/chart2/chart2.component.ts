...
export class Chart2Component implements OnInit {
  ...
  ngOnInit() {
    ...
    const fakeGreen =  [ { 'month': 8, 'x': 40, 'y': 180},  { 'month': 9, 'x': (this.w - 140) / 4 + 40, 'y': 160},
      { 'month': 10, 'x': (this.w - 140) / 4 * 2 + 40, 'y': 155}, { 'month': 11, 'x': (this.w - 140) / 4 * 3 + 40, 'y': 145},
      { 'month': 12, 'x': this.w - 100 , 'y': 125}];
